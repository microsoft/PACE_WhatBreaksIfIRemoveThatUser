...
namespace FlowOwnershipAudit
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Flow Ownership Audit"),
        ExportMetadata("Description", "This tool enables the efficient tracking and management of Microsoft Flows and connection references owned by individual users."),
    ...
    public class FlowOwnershipAudit : PluginBase, INoConnectionRequired
    {
        ...
        {
            return new FlowOwnershipAuditControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public FlowOwnershipAudit()
        {
